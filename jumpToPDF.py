...
class jump_to_pdfCommand(sublime_plugin.TextCommand):
	...
	def map_lytex2tex(self, old_line, fileName):
		...
		while i < old_line:
			i, r = jump_aux.line_of_next_occurrence(lytex, ii, jump_aux.lytex_scope_open)
			# print "i = ", i
			ii, r = jump_aux.line_of_next_occurrence(lytex, i, jump_aux.lytex_scope_close)
			# print "ii = ", ii
			j, r = jump_aux.line_of_next_occurrence(tex, jj, jump_aux.lytex_scope_open)
			# print "j = ", j
			jj, r = jump_aux.line_of_next_occurrence(tex, j, jump_aux.lytex_scope_close)
			# print "jj = ", jj
